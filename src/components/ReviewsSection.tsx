...
export const ReviewsSection = () => {
  ...
  const translatePercent = safeCurrentIndex * (100 / visibleCount);
  ...
  return (
    ...
    >
      <div className="w-full">
        <div
          className="reveal opacity-0 flex flex-col gap-6 md:flex-row md:items-end md:justify-between"
        ...
        >
          <div>
            ...
            <h2 className="mt-4 text-[34px] font-normal leading-[1.08] tracking-tight text-white sm:text-[44px] md:text-[54px]">
          ...
          <div className="flex gap-3 mt-4 md:mt-0">
            <button
              onClick={prevSlide}
              className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 text-white transition-all duration-300 hover:border-[#b9d522] hover:text-[#b9d522] focus:outline-none cursor-pointer"
        ...
        >
          ...
          >
            {reviews.map((rev, idx) => (
              ...
              >
                <div
                  className="relative overflow-hidden bg-[#131313] border border-white/[0.04] rounded-xl p-6 sm:p-8 md:p-10 flex flex-col justify-between h-full text-left"
                  style={{ minHeight: 'min(340px, 75vh)' }}
                >
                  <Quote
                    size={120}
                    className="absolute right-4 bottom-4 text-white/[0.015] rotate-180 pointer-events-none"
                    ...
                    <img
                      ...
                      onError={(e) => {
                        (e.target as HTMLImageElement).src =
                          'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="%23ffffff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/></svg>';
                      }}
                    />
